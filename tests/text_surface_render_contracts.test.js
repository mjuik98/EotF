...
describe('text surface render contracts', () => {
  it('keeps player-facing description surfaces on highlighted or safe render paths', () => {
    const expectations = [
      ...
      ['game/features/event/presentation/browser/event_runtime_shell_presenter.js', 'DomSafe.setHighlightedText'],
      ['game/features/event/presentation/browser/event_choice_resolution_presenter.js', 'DomSafe.setHighlightedText'],
      ...
      ['game/features/title/platform/browser/character_select_info_panel_sections.js', 'DescriptionUtils.highlight'],
