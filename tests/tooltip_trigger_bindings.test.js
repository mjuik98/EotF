...
describe('tooltip_trigger_bindings', () => {
  ...
  it('moves repeated tooltip trigger wiring onto the shared helper', () => {
    const targetFiles = [
      ['game/features/combat/presentation/browser/tooltip_ui.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/hud_panel_item_runtime_helpers.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/combat_enemy_card_ui.js', 'bindEnemyIntentTooltip('],
      ['game/features/combat/presentation/browser/combat_enemy_card_sections_ui.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/combat_relic_rail_ui.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/status_effects_ui.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/combat_enemy_status_badges_ui.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/class_trait_panel_ui.js', 'public_shared_support_capabilities.js'],
      ['game/features/combat/presentation/browser/hud_panel_sections.js', 'public_shared_support_capabilities.js'],
      ['game/features/event/presentation/browser/event_ui_item_shop.js', 'public_shared_support_capabilities.js'],
      ['game/features/event/presentation/browser/event_ui_card_discard.js', 'public_shared_support_capabilities.js'],
      ['game/features/reward/presentation/browser/reward_ui_option_renderers.js', 'public_shared_support_capabilities.js'],
      ['game/features/run/platform/browser/register_run_entry_bindings.js', 'public_shared_support_capabilities.js'],
      ['game/features/run/presentation/browser/map_ui_full_map.js', 'public_shared_support_capabilities.js'],
      ['game/features/run/presentation/browser/map_ui_next_nodes_relic_slots.js', 'public_shared_support_capabilities.js'],
      ['game/features/title/platform/browser/character_select_info_panel_interactions.js', 'public_shared_support_capabilities.js'],
      ['game/features/title/platform/browser/class_select_buttons_ui.js', 'public_shared_support_capabilities.js'],
    ];
