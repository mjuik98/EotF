...
export const ENEMIES = {
  ...
  // Region 2
  memory_specter: makeBasicEnemy({ id: 'memory_specter', name: '기억의 환령', icon: '👁️', hp: 50, atk: 14, region: 2, xp: 35, gold: 14, effectEvery: 4, effect: 'exhaust_card', effectIntent: '기억 탈취' }),
  nightmare_hound: makeBasicEnemy({ id: 'nightmare_hound', name: '악몽의 사냥개', icon: '🐕', hp: 44, atk: 13, region: 2, xp: 30, gold: 12, comboEvery: 4, comboHits: 2, comboBonus: -1, comboIntent: '악몽 연속 찢기' }),
  phantom_soldier: makeBasicEnemy({ id: 'phantom_soldier', name: '환영 병사', icon: '👤', hp: 40, atk: 12, region: 2, xp: 32, gold: 13, effectEvery: 2, effect: 'dodge', effectIntent: '위상 이동' }),
  memory_thief: makeBasicEnemy({ id: 'memory_thief', name: '기억 도둑', icon: '👤', hp: 44, atk: 13, region: 2, xp: 38, gold: 25, effectEvery: 4, effect: 'exhaust_card', effectIntent: '탈취' }),
  mirror_shade: makeBasicEnemy({ id: 'mirror_shade', name: '거울 그림자', icon: '🪞', hp: 48, atk: 12, region: 2, xp: 42, gold: 18, effectEvery: 2, effect: 'thorns', effectIntent: '반사' }),
  labyrinth_shade: makeBasicEnemy({ id: 'labyrinth_shade', name: '미궁의 그림자', icon: '🌑', hp: 46, atk: 12, region: 2, xp: 36, gold: 15, effectEvery: 2, effect: 'dodge', effectIntent: '은폐' }),
  nightmare_specter: makeBasicEnemy({ id: 'nightmare_specter', name: '악몽의 망령', icon: '👻', hp: 52, atk: 14, region: 2, xp: 40, gold: 16 }),
  ...
  labyrinth_heart: makeMiniBossEnemy({ id: 'labyrinth_heart', name: '미궁의 심장', icon: '🧿', hp: 175, atk: 17, region: 2, xp: 124, gold: 66, maxPhase: 2, specialEffect: 'exhaust_card', specialBonus: 10, stunEvery: 5, stunBonus: 0 }),
  memory_sovereign: makeBossEnemy({ id: 'memory_sovereign', name: '기억의 군주', icon: '👑', hp: 220, atk: 18, region: 2, xp: 150, gold: 70, maxPhase: 3, specialEffect: 'drain_echo', stunEvery: 5, stunBonus: 0 }),
  ...
  // Region 3
  divine_remnant: makeBasicEnemy({ id: 'divine_remnant', name: '신의 잔재', icon: '⚡', hp: 70, atk: 15, region: 3, xp: 50, gold: 22, effectEvery: 5, effect: 'drain_energy', effectIntent: '심판' }),
  cursed_paladin: makeBasicEnemy({ id: 'cursed_paladin', name: '저주받은 기사단', icon: '⚔️', hp: 65, atk: 13, region: 3, xp: 48, gold: 22, comboEvery: 4, comboHits: 2, comboBonus: 0, comboIntent: '저주 연속 참격' }),
  tomb_guardian: makeBasicEnemy({ id: 'tomb_guardian', name: '무덤 파수병', icon: '🛡️', hp: 85, atk: 11, region: 3, xp: 45, gold: 20, effectEvery: 3, effect: 'self_shield', effectIntent: '석화 방어', stunEvery: 6, stunBonus: 2, stunIntent: '석관 분쇄' }),
  holy_specter: makeBasicEnemy({ id: 'holy_specter', name: '성스러운 환령', icon: '✨', hp: 68, atk: 15, region: 3, xp: 55, gold: 24 }),
  holy_guardian: makeBasicEnemy({ id: 'holy_guardian', name: '성소 수호병', icon: '🏯', hp: 80, atk: 12, region: 3, xp: 46, gold: 21, effectEvery: 3, effect: 'self_shield', effectIntent: '성역 방어' }),
  divine_servant: makeBasicEnemy({ id: 'divine_servant', name: '신의 하인', icon: '🔅', hp: 72, atk: 13, region: 3, xp: 44, gold: 19, effectEvery: 4, effect: 'weaken', effectIntent: '속박의 빛' }),
  ...
  sepulcher_arbiter: makeMiniBossEnemy({ id: 'sepulcher_arbiter', name: '묘지 중재자', icon: '⚱️', hp: 205, atk: 19, region: 3, xp: 145, gold: 74, maxPhase: 2, specialEffect: 'drain_energy', specialBonus: 11, stunEvery: 4, stunBonus: 1 }),
  ...
  grave_executor: makeBossEnemy({ id: 'grave_executor', name: '무덤의 집행자', icon: '🪓', hp: 210, atk: 19, region: 3, xp: 155, gold: 72, maxPhase: 2, specialEffect: 'lifesteal', comboEvery: 4, comboHits: 2, comboBonus: 0, comboIntent: '집행 연속 베기' }),

  // Region 4
  echo_devourer: makeBasicEnemy({ id: 'echo_devourer', name: '메아리 포식자', icon: '🌑', hp: 65, atk: 18, region: 4, xp: 60, gold: 30, effectEvery: 3, effect: 'drain_echo', effectIntent: '잔향 포식' }),
  void_remnant: makeBasicEnemy({ id: 'void_remnant', name: '허공의 잔재', icon: '🌌', hp: 55, atk: 16, region: 4, xp: 52, gold: 26, effectEvery: 3, effect: 'drain_echo', effectIntent: '공허 흡수' }),
  void_eye_enemy: makeBasicEnemy({ id: 'void_eye_enemy', name: '허공의 눈', icon: '👁️', hp: 62, atk: 18, region: 4, xp: 58, gold: 32, effectEvery: 3, effect: 'weaken_vulnerable', effectIntent: '심연의 시선', stunEvery: 6, stunBonus: 0, stunIntent: '심연 응시' }),
  void_walker: makeBasicEnemy({ id: 'void_walker', name: '허공 보행자', icon: '🚶', hp: 58, atk: 19, region: 4, xp: 62, gold: 35, effectEvery: 2, effect: 'dodge', effectIntent: '점멸', comboEvery: 5, comboHits: 2, comboBonus: -4, comboIntent: '점멸 연타' }),
  reality_shredder: makeBasicEnemy({ id: 'reality_shredder', name: '현실 파쇄자', icon: '🌪️', hp: 75, atk: 21, region: 4, xp: 70, gold: 40, effectEvery: 4, effect: 'drain_echo', effectIntent: '현실 절단' }),
  void_core_fragment: makeBasicEnemy({ id: 'void_core_fragment', name: '허공 핵 파편', icon: '💠', hp: 64, atk: 17, region: 4, xp: 55, gold: 28, effectEvery: 3, effect: 'drain_echo', effectIntent: '맥동' }),
  ...
  rift_collector: makeMiniBossEnemy({ id: 'rift_collector', name: '균열 수집자', icon: '🌀', hp: 245, atk: 20, region: 4, xp: 172, gold: 90, maxPhase: 3, specialEffect: 'drain_echo', specialBonus: 12, comboEvery: 4, comboHits: 2, comboBonus: -3, comboIntent: '균열 연속 절단' }),
