...
export const ENEMIES = {
  ...
  shadow_wolf: makeBasicEnemy({ id: 'shadow_wolf', name: '그림자 늑대', icon: '🐺', hp: 35, atk: 10, region: 0, xp: 18, gold: 10 }),
  ...
  silent_shade: makeBasicEnemy({ id: 'silent_shade', name: '침묵의 그림자', icon: '🌑', hp: 35, atk: 12, region: 1, xp: 32, gold: 13, effectEvery: 2, effect: 'dodge', effectIntent: '은신' }),
  ...
  nightmare_hound: makeBasicEnemy({ id: 'nightmare_hound', name: '악몽의 사냥개', icon: '🐕', hp: 44, atk: 13, region: 2, xp: 30, gold: 12 }),
  ...
  cursed_paladin: makeBasicEnemy({ id: 'cursed_paladin', name: '저주받은 기사단', icon: '⚔️', hp: 65, atk: 13, region: 3, xp: 48, gold: 22 }),
  tomb_guardian: makeBasicEnemy({ id: 'tomb_guardian', name: '무덤 파수병', icon: '🛡️', hp: 85, atk: 11, region: 3, xp: 45, gold: 20, effectEvery: 3, effect: 'self_shield', effectIntent: '석화 방어' }),
  ...
  void_eye_enemy: makeBasicEnemy({ id: 'void_eye_enemy', name: '허공의 눈', icon: '👁️', hp: 62, atk: 18, region: 4, xp: 58, gold: 32, effectEvery: 3, effect: 'weaken_vulnerable', effectIntent: '심연의 시선' }),
  void_walker: makeBasicEnemy({ id: 'void_walker', name: '허공 보행자', icon: '🚶', hp: 58, atk: 19, region: 4, xp: 62, gold: 35, effectEvery: 2, effect: 'dodge', effectIntent: '점멸' }),
  ...
  time_fracture: makeMiniBossEnemy({ id: 'time_fracture', name: '시간 균열', icon: '🕳️', hp: 180, atk: 18, region: 5, xp: 120, gold: 70, maxPhase: 3, specialEffect: 'heal_30' }),
  ...
  abyss_queen: makeMiniBossEnemy({ id: 'abyss_queen', name: '심연 여왕', icon: '👸', hp: 220, atk: 20, region: 6, xp: 150, gold: 80, maxPhase: 2, specialEffect: 'heal_15' }),
  ...
  deep_origin: makeBossEnemy({ id: 'deep_origin', name: '심해의 근원', icon: '🌌', hp: 350, atk: 25, region: 6, xp: 280, gold: 150, isHidden: true, maxPhase: 3, specialEffect: 'drain_echo' }),
};
