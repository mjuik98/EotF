...
export const ENEMIES = {
  ...
  elite_dire_wolf: makeEliteEnemy({ id: 'elite_dire_wolf', name: '다이어 울프', icon: '🐾', hp: 80, atk: 12, region: 0, xp: 50, gold: 30 }),
  elite_ancient_tree: makeEliteEnemy({ id: 'elite_ancient_tree', name: '고목 수호자', icon: '🌳', hp: 110, atk: 11, region: 0, xp: 75, gold: 40 }),
  elite_moss_monarch: makeEliteEnemy({ id: 'elite_moss_monarch', name: '이끼 군주', icon: '👑', hp: 90, atk: 12, region: 0, xp: 70, gold: 40 }),
  ...
  elite_silence_herald: makeEliteEnemy({ id: 'elite_silence_herald', name: '침묵 사도', icon: '🗿', hp: 95, atk: 16, region: 1, xp: 70, gold: 38 }),
  elite_gear_titan: makeEliteEnemy({ id: 'elite_gear_titan', name: '톱니 타이탄', icon: '⚙️', hp: 120, atk: 15, region: 1, xp: 80, gold: 45 }),
  elite_echo_judge: makeEliteEnemy({ id: 'elite_echo_judge', name: '잔향 심판관', icon: '⚖️', hp: 100, atk: 14, region: 1, xp: 75, gold: 40 }),
  ...
  elite_memory_lich: makeEliteEnemy({ id: 'elite_memory_lich', name: '기억 리치', icon: '💀', hp: 145, atk: 18, region: 2, xp: 85, gold: 50 }),
  elite_maze_master: makeEliteEnemy({ id: 'elite_maze_master', name: '미궁 주권자', icon: '🌀', hp: 160, atk: 20, region: 2, xp: 95, gold: 60 }),
  elite_soul_reaper: makeEliteEnemy({ id: 'elite_soul_reaper', name: '영혼 수확자', icon: '⚔️', hp: 155, atk: 22, region: 2, xp: 100, gold: 65 }),
  ...
  elite_fallen_deity: makeEliteEnemy({ id: 'elite_fallen_deity', name: '타락천사', icon: '👼', hp: 180, atk: 24, region: 3, xp: 90, gold: 55 }),
  elite_grave_lord: makeEliteEnemy({ id: 'elite_grave_lord', name: '무덤 군주', icon: '☠️', hp: 200, atk: 26, region: 3, xp: 100, gold: 60 }),
  elite_judgement_hand: makeEliteEnemy({ id: 'elite_judgement_hand', name: '심판의 손', icon: '🖐️', hp: 190, atk: 28, region: 3, xp: 95, gold: 58 }),
  ...
  elite_echo_colossus: makeEliteEnemy({ id: 'elite_echo_colossus', name: '잔향 거신', icon: '🌟', hp: 280, atk: 32, region: 4, xp: 120, gold: 70 }),
  elite_origin_guard: makeEliteEnemy({ id: 'elite_origin_guard', name: '근원 수호자', icon: '🛡️', hp: 320, atk: 30, region: 4, xp: 140, gold: 80 }),
  elite_void_templar: makeEliteEnemy({ id: 'elite_void_templar', name: '허공 기사', icon: '⚔️', hp: 300, atk: 30, region: 4, xp: 130, gold: 75 }),
