...
export const ENEMIES = {
    // ── 잔향의 숲 추가 몬스터 ──
    slime: {
        id: 'slime', name: '슬라임', icon: '💧', hp: 20, maxHp: 20, atk: 5, region: 0, xp: 10, gold: 5,
        ai(turn) { return { type: 'strike', intent: `공격 ${this.atk}`, dmg: this.atk }; }
    },
    goblin: {
        id: 'goblin', name: '고블린', icon: '👺', hp: 25, maxHp: 25, atk: 6, region: 0, xp: 12, gold: 8,
        ai(turn) {
    ...
    orc: {
        id: 'orc', name: '오크', icon: '👹', hp: 45, maxHp: 45, atk: 8, region: 0, xp: 20, gold: 12,
        ai(turn) {
    ...
    shadow_wolf: {
        id: 'shadow_wolf', name: '그림자 늑대', icon: '🐺', hp: 35, maxHp: 35, atk: 10, region: 0, xp: 18, gold: 10,
        ai(turn) {
    ...
    forest_wraith: {
        id: 'forest_wraith', name: '숲의 망령', icon: '👻', hp: 40, maxHp: 40, atk: 9, region: 0, xp: 22, gold: 12,
        ai(turn) {
    ...
    elite_dire_wolf: {
        id: 'elite_dire_wolf', name: '【정예】다이어 울프', icon: '🐾', hp: 80, maxHp: 80, atk: 12, region: 0, xp: 50, gold: 30, isElite: true,
        ai(turn) {
    ...
    fallen_knight: {
        id: 'fallen_knight', name: '타락한 기사', icon: '⚔️', hp: 55, maxHp: 55, atk: 12, region: 0, xp: 35, gold: 15,
        ai(turn) {
    ...
    moss_golem: {
        id: 'moss_golem', name: '이끼 골렘', icon: '🪨', hp: 50, maxHp: 50, atk: 9, region: 0, xp: 28, gold: 12,
        ai(turn) {
    ...
    echo_bat: {
        id: 'echo_bat', name: '잔향 박쥐', icon: '🦇', hp: 28, maxHp: 28, atk: 8, region: 0, xp: 18, gold: 7,
        ai(turn) {
    ...
    verdant_slayer: {
        id: 'verdant_slayer', name: '초록 학살자', icon: '🌲', hp: 32, maxHp: 32, atk: 9, region: 0, xp: 22, gold: 9,
        ai(turn) {
    ...
    thistle_back: {
        id: 'thistle_back', name: '엉겅퀴 등피', icon: '🌵', hp: 40, maxHp: 40, atk: 7, region: 0, xp: 24, gold: 10,
        ai(turn) {
    ...
    elite_moss_monarch: {
        id: 'elite_moss_monarch', name: '【정예】이끼 군주', icon: '👑', hp: 90, maxHp: 90, atk: 12, region: 0, xp: 70, gold: 40, isElite: true,
        ai(turn) {
    ...
    elite_ancient_tree: {
        id: 'elite_ancient_tree', name: '【정예】고목 수호자', icon: '🌳', hp: 110, maxHp: 110, atk: 11, region: 0, xp: 75, gold: 40, isElite: true,
        ai(turn) {
    ...
    forest_guardian: {
        id: 'forest_guardian', name: '숲의 수호자', icon: '🛡️', hp: 160, maxHp: 160, atk: 14, region: 0, xp: 140, gold: 60, isBoss: true, maxPhase: 2,
        ai(turn) {
    ...
    ancient_echo: {
        id: 'ancient_echo', name: '태고의 잔향', icon: '🌑', hp: 145, maxHp: 145, atk: 16, region: 0, xp: 120, gold: 50, isBoss: true, maxPhase: 2, phase: 1,
        ai(turn) {
    ...
    // ── 침묵의 도시 ──
    silent_sentinel: {
        id: 'silent_sentinel', name: '침묵 파수꾼', icon: '🗿', hp: 60, maxHp: 60, atk: 14, region: 1, xp: 40, gold: 18,
        ai(turn) {
    ...
    noise_wraith: {
        id: 'noise_wraith', name: '소음 원령', icon: '📢', hp: 42, maxHp: 42, atk: 13, region: 1, xp: 38, gold: 16,
        ai(turn) {
    ...
    iron_automaton: {
        id: 'iron_automaton', name: '철제 자동병', icon: '🤖', hp: 65, maxHp: 65, atk: 12, region: 1, xp: 42, gold: 20,
        ai(turn) {
    ...
    rust_stalker: {
        id: 'rust_stalker', name: '녹슨 추적자', icon: '👤', hp: 38, maxHp: 38, atk: 11, region: 1, xp: 35, gold: 14,
        ai(turn) {
    ...
    brass_guardian: {
        id: 'brass_guardian', name: '황동 수호병', icon: '🛡️', hp: 70, maxHp: 70, atk: 10, region: 1, xp: 40, gold: 18,
        ai(turn) {
    ...
    silent_shade: {
        id: 'silent_shade', name: '침묵의 그림자', icon: '🌑', hp: 35, maxHp: 35, atk: 12, region: 1, xp: 32, gold: 13,
        ai(turn) {
    ...
    elite_silence_herald: {
        id: 'elite_silence_herald', name: '【정예】침묵 사도', icon: '🗿', hp: 95, maxHp: 95, atk: 16, region: 1, xp: 70, gold: 38, isElite: true,
        ai(turn) {
    ...
    elite_gear_titan: {
        id: 'elite_gear_titan', name: '【정예】톱니 타이탄', icon: '⚙️', hp: 120, maxHp: 120, atk: 15, region: 1, xp: 80, gold: 45, isElite: true,
        ai(turn) {
    ...
    elite_echo_judge: {
        id: 'elite_echo_judge', name: '【정예】잔향 심판관', icon: '⚖️', hp: 100, maxHp: 100, atk: 14, region: 1, xp: 75, gold: 40, isElite: true,
        ai(turn) {
    ...
    silent_tyrant: {
        id: 'silent_tyrant', name: '침묵의 폭군', icon: '🗣️', hp: 200, maxHp: 200, atk: 17, region: 1, xp: 130, gold: 55, isBoss: true, maxPhase: 2, phase: 1,
        ai(turn) {
    ...
    clockwork_emperor: {
        id: 'clockwork_emperor', name: '태엽 황제', icon: '⚙️', hp: 220, maxHp: 220, atk: 18, region: 1, xp: 150, gold: 70, isBoss: true, maxPhase: 2,
        ai(turn) {
    ...
    // ── 기억의 미궁 ──
    memory_specter: {
        id: 'memory_specter', name: '기억의 환령', icon: '👁️', hp: 50, maxHp: 50, atk: 14, region: 2, xp: 35, gold: 14,
        ai(turn) {
    ...
    nightmare_hound: {
        id: 'nightmare_hound', name: '악몽의 사냥개', icon: '🐕', hp: 44, maxHp: 44, atk: 13, region: 2, xp: 30, gold: 12,
        ai(turn) {
    ...
    phantom_soldier: {
        id: 'phantom_soldier', name: '환영 병사', icon: '👤', hp: 40, maxHp: 40, atk: 12, region: 2, xp: 32, gold: 13,
        ai(turn) {
    ...
    memory_thief: {
        id: 'memory_thief', name: '기억 도둑', icon: '👤', hp: 44, maxHp: 44, atk: 13, region: 2, xp: 38, gold: 25,
        ai(turn) {
    ...
    mirror_shade: {
        id: 'mirror_shade', name: '거울 그림자', icon: '🪞', hp: 48, maxHp: 48, atk: 12, region: 2, xp: 42, gold: 18,
        ai(turn) {
    ...
    labyrinth_shade: {
        id: 'labyrinth_shade', name: '미궁의 그림자', icon: '🌑', hp: 46, maxHp: 46, atk: 12, region: 2, xp: 36, gold: 15,
        ai(turn) {
    ...
    nightmare_specter: {
        id: 'nightmare_specter', name: '악몽의 망령', icon: '👻', hp: 52, maxHp: 52, atk: 14, region: 2, xp: 40, gold: 16,
        ai(turn) {
    ...
    elite_memory_lich: {
        id: 'elite_memory_lich', name: '【정예】기억 리치', icon: '💀', hp: 100, maxHp: 100, atk: 15, region: 2, xp: 72, gold: 42, isElite: true,
        ai(turn) {
    ...
    elite_maze_master: {
        id: 'elite_maze_master', name: '【정예】미궁 주권자', icon: '🌀', hp: 115, maxHp: 115, atk: 17, region: 2, xp: 85, gold: 50, isElite: true,
        ai(turn) {
    ...
    elite_soul_reaper: {
        id: 'elite_soul_reaper', name: '【정예】영혼 수확자', icon: '⚔️', hp: 110, maxHp: 110, atk: 18, region: 2, xp: 90, gold: 55, isElite: true,
        ai(turn) {
    ...
    memory_sovereign: {
        id: 'memory_sovereign', name: '기억의 군주', icon: '👑', hp: 220, maxHp: 220, atk: 18, region: 2, xp: 150, gold: 70, isBoss: true, maxPhase: 3, phase: 1,
        ai(turn) {
    ...
    memory_weaver: {
        id: 'memory_weaver', name: '기억의 직조자', icon: '🕸️', hp: 190, maxHp: 190, atk: 16, region: 2, xp: 140, gold: 65, isBoss: true, maxPhase: 2,
        ai(turn) {
    ...
    // ── 신의 무덤 ──
    divine_remnant: {
        id: 'divine_remnant', name: '신의 잔재', icon: '⚡', hp: 70, maxHp: 70, atk: 15, region: 3, xp: 50, gold: 22,
        ai(turn) {
    ...
    cursed_paladin: {
        id: 'cursed_paladin', name: '저주받은 기사단', icon: '⚔️', hp: 65, maxHp: 65, atk: 13, region: 3, xp: 48, gold: 22,
        ai(turn) {
    ...
    tomb_guardian: {
        id: 'tomb_guardian', name: '무덤 파수병', icon: '🛡️', hp: 85, maxHp: 85, atk: 11, region: 3, xp: 45, gold: 20,
        ai(turn) {
    ...
    holy_guardian: {
        id: 'holy_guardian', name: '성소 수호병', icon: '🏯', hp: 80, maxHp: 80, atk: 12, region: 3, xp: 46, gold: 21,
        ai(turn) {
    ...
    divine_servant: {
        id: 'divine_servant', name: '신의 하인', icon: '🔅', hp: 72, maxHp: 72, atk: 13, region: 3, xp: 44, gold: 19,
        ai(turn) {
    ...
    holy_specter: {
        id: 'holy_specter', name: '성스러운 환령', icon: '✨', hp: 68, maxHp: 68, atk: 15, region: 3, xp: 55, gold: 24,
        ai(turn) {
    ...
    elite_fallen_deity: {
        id: 'elite_fallen_deity', name: '【정예】타락천사', icon: '👼', hp: 130, maxHp: 130, atk: 18, region: 3, xp: 90, gold: 55, isElite: true,
        ai(turn) {
    ...
    elite_judgement_hand: {
        id: 'elite_judgement_hand', name: '【정예】심판의 손', icon: '🖐️', hp: 135, maxHp: 135, atk: 21, region: 3, xp: 95, gold: 58, isElite: true,
        ai(turn) {
    ...
    elite_grave_lord: {
        id: 'elite_grave_lord', name: '【정예】무덤 군주', icon: '☠️', hp: 140, maxHp: 140, atk: 20, region: 3, xp: 100, gold: 60, isElite: true,
        ai(turn) {
    ...
    divine_tyrant: {
        id: 'divine_tyrant', name: '신의 심판관', icon: '⚖️', hp: 240, maxHp: 240, atk: 19, region: 3, xp: 160, gold: 75, isBoss: true, maxPhase: 3, phase: 1,
        ai(turn) {
    ...
    grave_executor: {
        id: 'grave_executor', name: '무덤의 집행자', icon: '🪓', hp: 210, maxHp: 210, atk: 19, region: 3, xp: 155, gold: 72, isBoss: true, maxPhase: 2,
        ai(turn) {
    ...
    // ── 허공의 끝 ──
    echo_devourer: {
        id: 'echo_devourer', name: '메아리 포식자', icon: '🌑', hp: 65, maxHp: 65, atk: 18, region: 4, xp: 60, gold: 30,
        ai(turn) {
    ...
    void_remnant: {
        id: 'void_remnant', name: '허공의 잔재', icon: '🌌', hp: 55, maxHp: 55, atk: 16, region: 4, xp: 52, gold: 26,
        ai(turn) {
    ...
    void_eye_enemy: {
        id: 'void_eye_enemy', name: '허공의 눈', icon: '👁️', hp: 62, maxHp: 62, atk: 18, region: 4, xp: 58, gold: 32,
        ai(turn) {
    ...
    void_walker: {
        id: 'void_walker', name: '허공 보행자', icon: '🚶', hp: 58, maxHp: 58, atk: 19, region: 4, xp: 62, gold: 35,
        ai(turn) {
    ...
    reality_shredder: {
        id: 'reality_shredder', name: '현실 파쇄자', icon: '🌪️', hp: 75, maxHp: 75, atk: 21, region: 4, xp: 70, gold: 40,
        ai(turn) {
    ...
    void_core_fragment: {
        id: 'void_core_fragment', name: '허공 핵 파편', icon: '💠', hp: 64, maxHp: 64, atk: 17, region: 4, xp: 55, gold: 28,
        ai(turn) {
    ...
    elite_origin_guard: {
        id: 'elite_origin_guard', name: '【정예】근원 수호자', icon: '🛡️', hp: 160, maxHp: 160, atk: 20, region: 4, xp: 140, gold: 80, isElite: true,
        ai(turn) {
    ...
    elite_echo_colossus: {
        id: 'elite_echo_colossus', name: '【정예】잔향 거신', icon: '🌟', hp: 135, maxHp: 135, atk: 20, region: 4, xp: 120, gold: 70, isElite: true,
        ai(turn) {
    ...
    elite_void_templar: {
        id: 'elite_void_templar', name: '【정예】허공 기사', icon: '⚔️', hp: 155, maxHp: 155, atk: 19, region: 4, xp: 130, gold: 75, isElite: true,
        ai(turn) {
    ...
    void_herald: {
        id: 'void_herald', name: '허공의 사도', icon: '🌌', hp: 280, maxHp: 280, atk: 20, region: 4, xp: 200, gold: 100, isBoss: true, maxPhase: 2, phase: 1,
        ai(turn) {
    ...
    echo_origin: {
        id: 'echo_origin', name: '잔향의 근원', icon: '🌟', hp: 320, maxHp: 320, atk: 22, region: 4, xp: 300, gold: 150, isBoss: true, isHidden: true, maxPhase: 3, phase: 1,
        ai(turn) {
