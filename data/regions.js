...
export const REGIONS = [
    ...
    },
    {
        ...
        name: '⏳ 시간의 황무지',
        rule: '시간의 왜곡',
        ruleDesc: "멈춘 모래 위로 흩어진 시간 파편이 전투의 흐름을 비틀어 놓습니다. <br><br><span style='color:var(--danger)'>[지역 규칙] 플레이어 턴 시작 시 카드를 1장 추가로 뽑습니다. 하지만 카드를 뽑을 때마다 '시간의 균열' 게이지가 누적되며, 게이지가 가득 차면 시간이 강제로 재조정되며 즉시 턴이 종료됩니다. 턴 종료 시 게이지는 초기화됩니다.</span>",
    ...
    },
    {
        ...
        name: '🌊 심연의 해안',
        rule: '심연 강화',
        ruleDesc: "짙은 심연의 조류가 적들을 뒤틀린 힘으로 물들입니다. <br><br><span style='color:var(--danger)'>[지역 규칙] 전투 시작 시 적들이 심연 강화 효과 하나를 무작위로 얻은 채 등장합니다.</span>",
