...
export const REGIONS = [
    ...
    },
    {
        ...
        name: '🏙️ 침묵의 도시',
        rule: '침묵의 저주',
        ruleDesc: '고요함 속에 잠긴 도시에서는 작은 소음조차 치명적입니다.\n\n[지역 규칙] 카드 사용 시 소음 게이지가 누적됩니다.',
        quote: '"침묵은 가장 큰 비명이다."',
        floors: 7,
    ...
    },
    {
        ...
        name: '🌀 기억의 미궁',
        rule: '망각의 안개',
        ruleDesc: '망각의 안개가 모든 것을 앗아갑니다.\n\n[지역 규칙] 매 턴 시작 시 패에 있는 무작위 카드 1장이 안개 속으로 영구히 소멸(소각)됩니다.',
    ...
    },
    {
        ...
        name: '⚰️ 신의 무덤',
        rule: '신성한 심판',
        ruleDesc: '거룩한 위압감이 영혼을 짓누릅니다.\n\n[지역 규칙] 신들의 권능에 눌려 매 턴 회복되는 기본 에너지가 1만큼 감소합니다.',
    ...
    },
    {
        ...
        name: '🌌 잔향의 근원',
        rule: '현실 붕괴',
        ruleDesc: '현실의 경계가 무너져 내리는 종착지입니다.\n\n[지역 규칙] 불안정한 현실로 인해 매 턴 종료 시 최대 잔향이 5씩 영구적으로 손실됩니다.',
        quote: '"모든 시작이자 끝인 곳."',
        floors: 7,
    ...
    },
    {
        ...
        name: '⏳ 시간의 황무지',
        rule: '시간의 왜곡',
        ruleDesc: "멈춘 모래 위로 흩어진 시간 파편이 전투의 흐름을 비틀어 놓습니다.\n\n[지역 규칙] 플레이어 턴 시작 시 카드를 1장 추가로 뽑습니다. 하지만 카드를 뽑을 때마다 '시간의 균열' 게이지가 누적되며, 게이지가 가득 차면 시간이 강제로 재조정되며 즉시 턴이 종료됩니다. 턴 종료 시 게이지는 초기화됩니다.",
    ...
    },
    {
        ...
        name: '🌊 심연의 해안',
        rule: '심연 강화',
        ruleDesc: '짙은 심연의 조류가 적들을 뒤틀린 힘으로 물들입니다.\n\n[지역 규칙] 전투 시작 시 적들이 심연 강화 효과 하나를 무작위로 얻은 채 등장합니다.',
...
export const START_DECKS = Object.freeze(
    Object.fromEntries(
        Object.entries(CLASS_METADATA).map(([classId, meta]) => [classId, [...(meta.startDeck || [])]])
    )
);
