...
- 최신 전체 검증:
  - `npm run lint` PASS
  - `npm test` PASS: `371 files / 869 tests`
  - `npm run build` PASS
  - Playwright smoke PASS:
    - `output/web-game/arch-refactor-smoke-34/shot-0.png`
    - `output/web-game/arch-refactor-smoke-34/shot-2.png`
    - `output/web-game/arch-refactor-smoke-34/state-0.json`
    - `output/web-game/arch-refactor-smoke-34/state-2.json`
