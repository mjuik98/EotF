...
export function getManualChunk(id) {
  ...
  if (normalized.endsWith('/data/status_tooltip_meta_data.js')) return 'ui-combat';
  ...
  if (normalized.endsWith('/game/features/combat/presentation/browser/combat_relic_rail_ui.js')) return 'ui-combat';
  if (normalized.endsWith('/game/features/combat/presentation/browser/combat_relic_visuals.js')) return 'ui-combat';
  if (normalized.endsWith('/game/features/combat/presentation/browser/item_tooltip_fallback_text.js')) return 'ui-combat';
  if (normalized.endsWith('/game/features/combat/presentation/browser/item_detail_navigation.js')) return 'ui-combat';
  if (normalized.endsWith('/game/features/combat/presentation/browser/item_detail_state.js')) return 'ui-combat';
