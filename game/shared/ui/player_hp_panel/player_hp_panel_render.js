import { getPlayerHpPanelLevel } from '../../runtime/player_hp_panel_level.js';
...
export function buildFloatingPlayerHpPanel(doc, gs, deps = {}, options = {}) {
  ...
  const statusEffectsUI = options.statusEffectsUI;
  const palette = {
    critical: {
  ...
  hpBarOuter.append(hpBarFill, createEl(doc, 'div', 'nc-hp-scan'));
  ...
  const pctEl = createEl(doc, 'span', 'nc-hp-pct');
