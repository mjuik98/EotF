...
import { RunRules, getRegionData, getBaseRegionIndex, getRegionCount } from '../systems/run_rules.js';
...
export const CombatMethods = {
    dealDamage(amount, targetIdx = null, noChain = false, deps = {}) {
        ...
        // EventBus 알림
        EventBus.emit(Actions.ENEMY_DAMAGE, { amount: dmg, targetIdx, hpAfter: enemy.hp, isDead: enemy.hp <= 0 });
    ...
    takeDamage(amount, deps = {}) {
        ...
        // EventBus 알림
        EventBus.emit(Actions.PLAYER_DAMAGE, { amount: dmg, hpAfter: this.player.hp, isDead: this.player.hp <= 0 });
