...
<div class="event-box gm-modal-panel gm-modal-accent-ember">
  <div class="gm-modal-header">
    <div class="gm-modal-header-main">
      <div class="event-eyebrow gm-modal-eyebrow" id="eventEyebrow">LAYER 1 · 우발적 이벤트</div>
      <div class="event-title gm-modal-title" id="eventTitle">이벤트</div>
    </div>
  </div>
  <div class="event-modal-body gm-modal-body">
