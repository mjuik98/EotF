...
export const CONSTANTS = Object.freeze({
  ...
  ECHO_SKILLS: Object.freeze({
    ...
    mage: {
      1: { cost: 30, desc: '적 약화 2턴 + 드로우 1 + Echo +10', shortDesc: '약화 2턴 + 드로우 + Echo 10', weaken: 2, draw: 1, echo: 10, log: '🔮 예지! 약화 2턴 + 드로우 1 + Echo 10' },
    ...
    shielder: {
      ...
      2: { cost: 60, desc: '방어막 55 + 전체 약화 3', shortDesc: '방어막 55 + 약화', shield: 55, weaken: 3, log: '🧱 철벽 요새! 방어막 55 + 적 전체 약화 3' },
      3: { cost: 100, desc: '방어막 70 + 1턴간 모든 피해 면역', shortDesc: '방어막 70 + 면역', shield: 70, immune: 1, log: '🧱 신의 아이기스! 방어막 70 + 1턴간 피해 면역' }
    },
  }),
