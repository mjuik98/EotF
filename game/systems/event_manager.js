/**
 * event_manager.js - compatibility facade over feature-local event helpers.
 */

import {
  pickRandomEvent,
  resolveEventChoice,
} from '../features/event/app/event_choice_actions.js';
import {
  createRestEvent,
  createShopEvent,
  ...
  shopBuyPotion,
  shopUpgradeCard,
} from '../features/event/app/event_shop_actions.js';
import {
  discardEventCard,
  generateItemShopStock,
  purchaseItem,
} from '../features/event/app/event_item_shop_actions.js';
